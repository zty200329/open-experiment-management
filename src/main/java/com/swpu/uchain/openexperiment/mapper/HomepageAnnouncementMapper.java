...
import com.swpu.uchain.openexperiment.domain.HomepageAnnouncement;
...
@Repository
public interface HomepageAnnouncementMapper {
    int deleteByPrimaryKey(Integer id);

    int insert(HomepageAnnouncement record);

    HomepageAnnouncement selectByPrimaryKey(Integer id);

    List<HomepageAnnouncement> selectAll();

    /**
     * 查询所有发布的
     * @return
     */
    List<HomepageAnnouncement> selectAllByPublished();
