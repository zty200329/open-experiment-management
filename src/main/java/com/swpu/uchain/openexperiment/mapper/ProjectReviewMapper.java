...
public interface ProjectReviewMapper {
    ...
    int updateGeneralByCollegeAndType2(@Param("college")Integer college,@Param("projectType")Integer projectType);

    int updateKeyByCollegeAndType2(@Param("college")Integer college);
}